...
puts "Creating Hens..."
Hen.create(name: "Marie-France", description: "Marie-France is a Crazy Hen, the craziest breed of hen in the world! She runs all day and lays crazy eggs", rating: 3.6, price_per_day: 10, breed: "Crazy Hen", eggs_per_day: 6, location: "Paris 75008", profile_picture: "https://res.cloudinary.com/charlotte-smets/image/upload/v1637144830/william-moreland-auijD19Byq8-unsplash_pbjcxg.jpg")
Hen.create(name: "Suzanne", description: "Suzanne is a Mega Hen, the best breed of hen in the world! She runs all day and lays mega eggs. She is super friendly with kids!", rating: 4.6, price_per_day: 100, breed: "Mega Hen", eggs_per_day: 50, location: "Paris 75006", profile_picture: "https://res.cloudinary.com/charlotte-smets/image/upload/v1637144828/shannon-vandenheuvel-bI9AeUn15_A-unsplash_sfviyx.jpg")
